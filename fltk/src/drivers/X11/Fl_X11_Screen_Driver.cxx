//
// "$Id: Fl_X11_Screen_Driver.cxx 12563 2017-11-17 17:25:33Z AlbrechtS $"
//
...
void Fl_X11_Screen_Driver::get_system_colors()
{
  ...
  if (!bg_set)
    getsyscolor(key1,  "background",	fl_bg,	"#e4e4e4", Fl::background);
...
//
// End of "$Id: Fl_X11_Screen_Driver.cxx 12563 2017-11-17 17:25:33Z AlbrechtS $".
//
