...
Fl_Input *v_input[6]={(Fl_Input *)0};

CodeEditor *vm_script_project_editor=(CodeEditor *)0;

CodeEditor *vm_script_user_editor=(CodeEditor *)0;

Fl_Button *btnSaveVmScript=(Fl_Button *)0;

Fl_Button *btnCheckVmScript=(Fl_Button *)0;

Fl_Button *btnReloadVmScript=(Fl_Button *)0;

Fl_Button *wLiveMode=(Fl_Button *)0;

Fl_Double_Window* make_widget_panel() {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = new Fl_Double_Window(420, 425);
    w = o;
    o->labelsize(11);
    o->align(Fl_Align(FL_ALIGN_CLIP|FL_ALIGN_INSIDE));
    o->hotspot(o);
    { Fl_Tabs* o = new Fl_Tabs(8, 10, 407, 380);
      o->selection_color((Fl_Color)12);
      o->labelsize(11);
      o->labelcolor(FL_BACKGROUND2_COLOR);
      o->callback((Fl_Callback*)cb_);
      o->when(FL_WHEN_NEVER);
      { Fl_Group* o = new Fl_Group(10, 30, 405, 360, "GUI");
        o->labelsize(11);
...
ive to the origin at construction time");
      ...
      { Fl_Group* o = new Fl_Group(10, 30, 405, 360, "Style");
        o->labelsize(11);
        o->callback((Fl_Callback*)propagate_load);
        o->when(FL_WHEN_NEVER);
        o->hide();
      ...
      { Fl_Group* o = new Fl_Group(10, 30, 405, 360, "C++");
        o->labelsize(11);
        o->callback((Fl_Callback*)propagate_load);
        o->when(FL_WHEN_NEVER);
        o->hide();
        { v_input[4] = new Fl_Input(95, 40, 310, 20, "Before all:");
          v_input[4]->tooltip("Extra initialization code for the widget before creation.");
          v_input[4]->labelfont(1);
          v_input[4]->labelsize(11);
          v_input[4]->textfont(4);
          v_input[4]->textsize(11);
          v_input[4]->callback((Fl_Callback*)v_input_cb, (void*)(4));
        } // Fl_Input* v_input[4]
        { Fl_Group* o = new Fl_Group(95, 65, 310, 20, "Class:");
          o->labelfont(1);
          o->labelsize(11);
          o->callback((Fl_Callback*)propagate_load);
          o->align(Fl_Align(FL_ALIGN_LEFT));
          { Fl_Input* o = new Fl_Input(95, 65, 172, 20);
          ...
          { Fl_Choice* o = new Fl_Choice(265, 65, 140, 20);
        ...
        { Fl_Group* o = new Fl_Group(95, 90, 310, 20, "Name:");
          o->labelfont(1);
          o->labelsize(11);
          o->callback((Fl_Callback*)propagate_load);
          o->align(Fl_Align(FL_ALIGN_LEFT));
          { Fl_Input* o = new Fl_Input(95, 90, 235, 20);
          ...
          { Fl_Choice* o = new Fl_Choice(330, 90, 75, 20);
        ...
        { Fl_Input* o = new Fl_Input(95, 113, 310, 20, "Macro Name:");
          o->tooltip("The name of the widget.");
          o->labelfont(1);
          o->labelsize(11);
          o->textsize(11);
          o->callback((Fl_Callback*)macro_name_cb);
          Fl_Group::current()->resizable(o);
        } // Fl_Input* o
        { v_input[0] = new Fl_Input(95, 135, 310, 20, "Extra Code:");
        ...
        { v_input[1] = new Fl_Input(95, 155, 310, 20);
        ...
        { v_input[2] = new Fl_Input(95, 175, 310, 20);
        ...
        { v_input[3] = new Fl_Input(95, 195, 310, 20);
        ...
        { CodeEditor* o = new CodeEditor(95, 220, 310, 90, "Callback:");
...
access the Widget pointer and \'v\' to access the user value.");
        ...
        { Fl_Group* o = new Fl_Group(95, 295, 310, 40, "User Data:");
          o->labelfont(1);
          o->labelsize(11);
          o->callback((Fl_Callback*)propagate_load);
          o->align(Fl_Align(FL_ALIGN_LEFT));
          { Fl_Input* o = new Fl_Input(95, 315, 158, 20);
          ...
          { Fl_Choice* o = new Fl_Choice(300, 315, 105, 20, "When:");
        ...
        { Fl_Group* o = new Fl_Group(95, 320, 310, 40, "Type:");
          o->labelfont(1);
          o->labelsize(11);
          o->callback((Fl_Callback*)propagate_load);
          o->align(Fl_Align(FL_ALIGN_LEFT));
          { Fl_Input* o = new Fl_Input(95, 340, 158, 20);
          ...
          { Fl_Light_Button* o = new Fl_Light_Button(300, 340, 105, 20, "No Change");
        ...
        { v_input[5] = new Fl_Input(95, 365, 310, 20, "After all:");
          v_input[5]->tooltip("Extra initialization code for the widget after creation.");
          v_input[5]->labelfont(1);
          v_input[5]->labelsize(11);
          v_input[5]->textfont(4);
          v_input[5]->textsize(11);
          v_input[5]->callback((Fl_Callback*)v_input_cb, (void*)(5));
        } // Fl_Input* v_input[5]
        o->end();
      } // Fl_Group* o
      { Fl_Group* o = new Fl_Group(10, 30, 405, 360, "Script");
        o->labelsize(11);
        o->callback((Fl_Callback*)propagate_load);
        o->when(FL_WHEN_NEVER);
        o->hide();
        { Fl_Tabs* o = new Fl_Tabs(10, 35, 400, 325);
          { Fl_Group* o = new Fl_Group(10, 60, 400, 300, "Project");
            { vm_script_project_editor = new CodeEditor(15, 65, 390, 290);
              vm_script_project_editor->tooltip("In some places you can place a \"=luafuncname\" at the start of the input, th\
is way fluid will try to call your lua function with the code to be emited and\
 will write whatever your function return.");
              vm_script_project_editor->box(FL_DOWN_BOX);
              vm_script_project_editor->color(FL_BACKGROUND2_COLOR);
              vm_script_project_editor->selection_color(FL_SELECTION_COLOR);
              vm_script_project_editor->labeltype(FL_NO_LABEL);
              vm_script_project_editor->labelfont(1);
              vm_script_project_editor->labelsize(11);
              vm_script_project_editor->labelcolor(FL_FOREGROUND_COLOR);
              vm_script_project_editor->textfont(4);
              vm_script_project_editor->textsize(11);
              vm_script_project_editor->callback((Fl_Callback*)vm_script_editor_cb);
              vm_script_project_editor->align(Fl_Align(FL_ALIGN_TOP));
              vm_script_project_editor->when(FL_WHEN_RELEASE);
              Fl_Group::current()->resizable(vm_script_project_editor);
            } // CodeEditor* vm_script_project_editor
            o->end();
          } // Fl_Group* o
          { Fl_Group* o = new Fl_Group(10, 60, 400, 300, "User");
            o->hide();
            { vm_script_user_editor = new CodeEditor(15, 65, 390, 290);
              vm_script_user_editor->tooltip("In some places you can place a \"=luafuncname\" at the start of the input, th\
is way fluid will try to call your lua function with the code to be emited and\
 will write whatever your function return.");
              vm_script_user_editor->box(FL_DOWN_BOX);
              vm_script_user_editor->color(FL_BACKGROUND2_COLOR);
              vm_script_user_editor->selection_color(FL_SELECTION_COLOR);
              vm_script_user_editor->labeltype(FL_NO_LABEL);
              vm_script_user_editor->labelfont(1);
              vm_script_user_editor->labelsize(11);
              vm_script_user_editor->labelcolor(FL_FOREGROUND_COLOR);
              vm_script_user_editor->textfont(4);
              vm_script_user_editor->textsize(11);
              vm_script_user_editor->callback((Fl_Callback*)vm_script_editor_cb);
              vm_script_user_editor->align(Fl_Align(FL_ALIGN_TOP));
              vm_script_user_editor->when(FL_WHEN_RELEASE);
              Fl_Group::current()->resizable(vm_script_user_editor);
            } // CodeEditor* vm_script_user_editor
            o->end();
            Fl_Group::current()->resizable(o);
          } // Fl_Group* o
          o->end();
        ...
        { btnSaveVmScript = new Fl_Button(321, 365, 84, 20, "Save");
          btnSaveVmScript->tooltip("Save this lua script with the project.");
          btnSaveVmScript->type(1);
          btnSaveVmScript->labelsize(11);
          btnSaveVmScript->callback((Fl_Callback*)save_vm_script_cb);
        } // Fl_Button* btnSaveVmScript
        { btnCheckVmScript = new Fl_Button(220, 365, 84, 20, "Check");
          btnCheckVmScript->tooltip("Try to compile the lua script and check for sintatic errors.");
          btnCheckVmScript->type(1);
          btnCheckVmScript->labelsize(11);
          btnCheckVmScript->callback((Fl_Callback*)check_vm_script_cb);
        } // Fl_Button* btnCheckVmScript
        { btnReloadVmScript = new Fl_Button(15, 365, 84, 20, "Reload");
          btnReloadVmScript->tooltip("Try to compile the lua script and check for sintatic errors.");
          btnReloadVmScript->type(1);
          btnReloadVmScript->labelsize(11);
          btnReloadVmScript->callback((Fl_Callback*)reload_vm_script_cb);
    ...
    { Fl_Group* o = new Fl_Group(9, 400, 400, 20);
      o->labelsize(11);
      { Fl_Box* o = new Fl_Box(9, 400, 20, 20);
        o->labelsize(11);
        Fl_Group::current()->resizable(o);
      } // Fl_Box* o
      { Fl_Button* o = new Fl_Button(240, 400, 99, 20, "Hide &Overlays");
        o->tooltip("Hide the widget overlay box.");
        o->labelsize(11);
        o->labelcolor((Fl_Color)1);
        o->callback((Fl_Callback*)overlay_cb);
      } // Fl_Button* o
      { Fl_Button* o = new Fl_Button(66, 400, 80, 20, "Revert");
        o->labelsize(11);
        o->callback((Fl_Callback*)revert_cb);
        o->hide();
      } // Fl_Button* o
      { Fl_Return_Button* o = new Fl_Return_Button(344, 400, 64, 20, "Close");
        o->labelsize(11);
        o->callback((Fl_Callback*)ok_cb);
      } // Fl_Return_Button* o
      { Fl_Button* o = new Fl_Button(339, 400, 70, 20, "Cancel");
        o->labelsize(11);
        o->callback((Fl_Callback*)cancel_cb);
        o->hide();
      } // Fl_Button* o
      { wLiveMode = new Fl_Button(151, 400, 84, 20, "Live &Mode");
