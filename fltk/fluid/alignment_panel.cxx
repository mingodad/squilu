...
Fl_Double_Window* make_global_settings_window() {
 ...
 dotted rectangle inside the widget that will receive the next keystroke. If s\
witched off, no such indicator will be drawn and keyboard navigation is disabl\
ed.\r\n\r\nDefault is on.");
 ...
 start or end of the text in a text widget will change focus to the next widge\
t. When switched off, the cursor will stop at the end of the text. Pressing Ta\
b or Ctrl-Tab will advance the keyboard focus. Switch this on, if you want the\
 old behavior of FLTK 1.1.\r\n\r\nDefault is off.");
...
a widget with a tooltip text will open a little tooltip window until the mouse\
 leaves the widget. If disabled, no tooltip is shown.\r\n\r\nDefault is on.");
...
and drag text from any text widget. If disabled, no dragging is possible, howe\
ver dropping text from other applications still works.\r\n\r\nDefault is on.");
