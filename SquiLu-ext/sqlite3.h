...
#define SQLITE_SOURCE_ID      "2016-08-02 13:26:34 b23c10ac8f65bc88a6c7d88e140217222eb4cbe5"
...
struct sqlite3_vfs {
  ...
  int (SQLITE_CALLBACK *xCurrentTime)(sqlite3_vfs*, sqlite_double*);
...
typedef struct sqlite3_str_accum sqlite3_str_accum;
SQLITE_API int SQLITE_APICALL sqlite3_str_accum_alloc(sqlite3_str_accum **p, char *zBase, int n, int mx);
SQLITE_API int SQLITE_APICALL sqlite3_str_accum_reserve(sqlite3_str_accum *p, int size);
SQLITE_API int SQLITE_APICALL sqlite3_str_accum_size(sqlite3_str_accum *p);
SQLITE_API int SQLITE_APICALL sqlite3_str_accum_resize(sqlite3_str_accum *p, int size, char fill);
SQLITE_API int SQLITE_APICALL sqlite3_str_accum_capacity(sqlite3_str_accum *p);
SQLITE_API void SQLITE_APICALL sqlite3_str_accum_free(sqlite3_str_accum *p);
SQLITE_API int SQLITE_APICALL sqlite3_str_accum_check(sqlite3_str_accum *p);
SQLITE_API void SQLITE_APICALL sqlite3_str_accum_reset(sqlite3_str_accum *p, int keepAllocated);
SQLITE_API char *SQLITE_APICALL sqlite3_str_accum_finish(sqlite3_str_accum *p, int keepAllocated);
SQLITE_API int SQLITE_APICALL sqlite3_str_accum_append(sqlite3_str_accum *p, const char *z, int N);
SQLITE_API char *SQLITE_APICALL sqlite3_str_accum_vprintf(sqlite3_str_accum *p, const char *zFormat, va_list ap);
SQLITE_API char *SQLITE_APICALL sqlite3_str_accum_printf(sqlite3_str_accum *p, const char *zFormat, ...);
SQLITE_API int SQLITE_APICALL sqlite3_isnprintf(char*, int, const char*, ...);
SQLITE_API int SQLITE_APICALL sqlite3_ivsnprintf(char*, int, const char*, va_list);
...
*/
SQLITE_API void *SQLITE_APICALL sqlite3_trace(sqlite3*, void(SQLITE_CALLBACK *xTrace)(void*,const char*), void*);
SQLITE_API void *SQLITE_APICALL sqlite3_trace_v0(sqlite3*, void(SQLITE_CALLBACK *xTrace)(void*,const char*), void*, int);
SQLITE_API SQLITE_EXPERIMENTAL void *SQLITE_APICALL sqlite3_profile(sqlite3*,
...
SQLITE_API void SQLITE_APICALL sqlite3_set_db_user_data(sqlite3 *db, void *data);
SQLITE_API void *SQLITE_APICALL sqlite3_get_db_user_data(sqlite3 *db);
...
SQLITE_API int SQLITE_APICALL sqlite3_bind_double(sqlite3_stmt*, int, sqlite_double);
...
SQLITE_API sqlite_double SQLITE_APICALL sqlite3_column_double(sqlite3_stmt*, int iCol);
...
SQLITE_API sqlite_double SQLITE_APICALL sqlite3_value_double(sqlite3_value*);
...
SQLITE_API void *SQLITE_APICALL sqlite3_db_user_data(sqlite3_context *context);
...
SQLITE_API void SQLITE_APICALL sqlite3_result_double(sqlite3_context*, sqlite_double);
...
SQLITE_API int SQLITE_APICALL sqlite3_CodecAttach(sqlite3* db, int nDb, const void* zKey, int nKey);
SQLITE_API void SQLITE_APICALL sqlite3_CodecGetKey(sqlite3* db, int nDb, void** zKey, int* nKey);
