...
#define SQLITE_SOURCE_ID      "2019-12-18 21:22:40 062e00c4d7e30155299339eaefe6cbe01953894baebf0af6d7ab3295b743alt1"
...
SQLITE_API int sqlite3_str_accum_alloc(sqlite3_str_accum **p, char *zBase, int n, int mx);
SQLITE_API int sqlite3_str_accum_reserve(sqlite3_str_accum *p, int size);
SQLITE_API int sqlite3_str_accum_size(sqlite3_str_accum *p);
SQLITE_API int sqlite3_str_accum_resize(sqlite3_str_accum *p, int size, char fill);
SQLITE_API int sqlite3_str_accum_capacity(sqlite3_str_accum *p);
SQLITE_API void sqlite3_str_accum_free(sqlite3_str_accum *p);
SQLITE_API int sqlite3_str_accum_check(sqlite3_str_accum *p);
SQLITE_API void sqlite3_str_accum_reset(sqlite3_str_accum *p, int keepAllocated);
SQLITE_API char *sqlite3_str_accum_finish(sqlite3_str_accum *p, int keepAllocated);
SQLITE_API int sqlite3_str_accum_append(sqlite3_str_accum *p, const char *z, int N);
SQLITE_API char *sqlite3_str_accum_vprintf(sqlite3_str_accum *p, const char *zFormat, va_list ap);
...
SQLITE_API void *sqlite3_db_user_data(sqlite3_context *context);
